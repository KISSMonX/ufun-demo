...
//开 发 者： MingH
//生成日期： 2015-5-29
//其他说明： SD 卡测试, DMA访问. 4-bus 模式. CD 用于中断检测热插拔状态
//**************************************************************/
 /*
...
/**
  ...
  * @param  SD_CardInfo structure pointer
  * @retval None
  */
...
/**
  * @brief  show the CSD information.
  * @param  SD_CardInfo structure pointer
  * @retval None
  */
void SD_ShowCSD(SD_CardInfo *SDCardInfo)
{
	...
	if( SDCardInfo->SD_csd.CSDStruct == 1)//Case V1.0
	{
...
void SD_LowLevel_DeInit(void)
{
	...
	/*!< Configure PC.07, PC.08, PC.09, PC.10, PC.11, PC.12 pin: CD, D0, D1, D2, D3, CLK pin */
...
void SD_LowLevel_Init(void)
{
	...
	// CD_SWITCH 这个引脚是机械检测, 检测的是热插拔状态. 最好使用 IO 口中断检测;
	// CD/DAT3 是电气检测, 可以利用软件检测有无SD卡插入;
